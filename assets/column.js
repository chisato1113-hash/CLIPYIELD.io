...
(function (global) {
  ...
  function aiTemplate(topic, keywords) {
    ...
    return [
      ...
      "### よくある質問",
      "",
      "フォロワーが少なくても申請できます。審査では編集の質・権利意識・過去の実績を見ています。通過後は実績に応じてティアが上がり単価も上がります。",
      "",
      "---",
      "",
      "関連キーワード：" + kw,
    ...
    var A = [
      {
        ...
        excerpt: "切り抜き動画で収益化する仕組みと、初心者が最短で始める手順を解説。審査を通過した公式切り抜き師として、実績に応じてティアと単価が上がります。",
        body: [
          "## 切り抜き動画で稼ぐ仕組み",
          "",
          "「切り抜き」とは、公式に許諾された映像・音声素材を短尺に編集してSNSへ投稿する活動です。CLIPYIELDでは、**再生報酬（TIER1）**と**グッズ成果報酬（TIER2）**の二階建てで収益が得られます。",
          "",
          "1. 無料登録 → 本人確認・活動用アカウント登録 → 審査を申請",
